  ...
  return (
    <section className="relative overflow-hidden pt-10">
      <div className="mx-auto max-w-7xl px-6 sm:px-10">
        <div className="mx-auto w-full rounded-3xl border border-border/70 bg-card/70 p-7 text-left shadow-sm backdrop-blur-sm duration-700 animate-in fade-in zoom-in md:w-11/12 md:p-10 md:text-center xl:w-9/12">
          <h1 className="mb-6 text-5xl leading-none tracking-wide text-foreground md:text-7xl">
            <span>Begin an exciting journey&nbsp;</span>
            <span className="block py-2 text-primary lg:inline">into the world of anime!</span>
          </h1>
          ...
          <p className="mb-8 px-0 text-base font-medium leading-relaxed text-foreground md:text-xl lg:px-24">
            ...
            <span className="py-2 font-bold text-primary">community</span>, for the{" "}
            <span className="py-2 font-bold text-primary">community</span>, by the{" "}
            <span className="py-2 font-bold text-primary">community</span>.
          </p>
