            ...
            >
              ...
              {slide.poster || wide ? (
                <Image
                  ...
                  className={cn(
                    "object-cover",
                    wide ? "scale-105" : "scale-110 blur-2xl brightness-[0.35]",
                  )}
                  unoptimized={!wide}
                />
              ) : null}
              ...
              <div className="relative mx-auto flex h-full max-w-[1600px] items-end px-4 pb-10 sm:px-6">
                <div className="flex items-end gap-6">
                  ...
                  <div className="max-w-2xl">
                    ...
                    <h2 className="font-display mt-3 text-3xl leading-[0.95] font-extrabold tracking-tighter uppercase sm:text-5xl lg:text-6xl">
                      {slide.title}
                    </h2>
                    {slide.meta ? (
                    ...
                    {slide.synopsis ? (
                      <p className="text-muted-foreground mt-3 line-clamp-2 max-w-xl text-sm sm:line-clamp-3">
                        {slide.synopsis}
                      </p>
                    ) : null}
                    ...
                    <Link
                      href={slide.href}
                      tabIndex={active ? 0 : -1}
                      className="press bg-foreground text-background hover:bg-primary hover:text-primary-foreground mt-5 inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold"
                    >
          ...
          {slides.map((slide, slideIndex) => (
            <button
              ...
              className={cn(
                ...
                slideIndex === index ? "bg-primary w-8" : "bg-foreground/30 hover:bg-foreground/60 w-4",
              )}
            />
          ))}
        </div>
